...
storiesOf('1-Presentation', module).add('1-Welcome to the playground', () => {
  return (
    <Layout>
        ...
        <article className="border-b">
          <div className="border-l-2 bg-grey-lightest border-indigo">
            <div className="pl-8 pr-8 pb-5 pt-5 text-grey-darkest">
              ...
              <p className="p-2">
                I started to work on a project and I quickly notice that I need
                an interface that gives me enough information about the
              ...
              <p className="p-2">
                The easiest way is to use the standalone mode, if you want more
                details{' '}
                <a
